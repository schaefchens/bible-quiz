// Demo quiz packs for the registry. Bilingual source data is defined once and
// flattened into separate EN and DE quiz objects at module load time.

function flatten(questions, lang) {
...
const OT = [
  ...
  { id:'ot16',difficulty:4,de:{text:'Was sagte Josua beim Erneuerungsbund kurz vor seinem Tod zum Volk Israel?',options:['"Seid stark und mutig!"','"Wählt heute, wem ihr dienen wollt!"','"Das Gesetz soll euch leiten!"','"Ihr sollt nicht fürchten!"']},en:{text:'What did Joshua say to Israel at the covenant renewal just before his death?',options:['"Be strong and courageous!"','"Choose this day whom you will serve!"','"Let the law guide you!"','"Do not be afraid!"']},correct:1,reference:'Joshua 24:15' },
  // D5
...
// ── Exported quizzes (flat, single-language) ─────────────────────────────────

export const demoQuizzes = [
  { id:'otqe', language:'en', name:'Old Testament Quiz',       description:'Journey through the Hebrew scriptures: creation, the patriarchs, the law, the prophets, and more.', author:'Biblionaire Team', version:'1.0', isPublished:true, questions:flatten(OT,'en') },
  { id:'otqd', language:'de', name:'Altes-Testament-Quiz',      description:'Reise durch die hebräischen Schriften: Schöpfung, Patriarchen, das Gesetz, die Propheten und mehr.',  author:'Biblionair Team',  version:'1.0', isPublished:true, questions:flatten(OT,'de') },
  { id:'ntqe', language:'en', name:'New Testament Quiz',        description:'Test your knowledge of the Gospels, Acts, the letters of Paul, and the book of Revelation.',          author:'Biblionaire Team', version:'1.0', isPublished:true, questions:flatten(NT,'en') },
  { id:'ntqd', language:'de', name:'Neues-Testament-Quiz',      description:'Teste dein Wissen über die Evangelien, die Apostelgeschichte, die Paulusbriefe und die Offenbarung.', author:'Biblionair Team',  version:'1.0', isPublished:true, questions:flatten(NT,'de') },
  { id:'wbqe', language:'en', name:'Whole Bible Quiz',          description:'A broad survey spanning both testaments — people, places, events, and theology across all 66 books.', author:'Biblionaire Team', version:'1.0', isPublished:true, questions:flatten(WB,'en') },
  { id:'wbqd', language:'de', name:'Gesamte-Bibel-Quiz',        description:'Ein breiter Überblick über beide Testamente – Personen, Orte, Ereignisse und Theologie durch alle 66 Bücher.', author:'Biblionair Team', version:'1.0', isPublished:true, questions:flatten(WB,'de') },
];
